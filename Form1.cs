...
namespace JsonWindowForm
{
	public partial class Form1 : Form
	{
		...
		private void Guardar_Boton1(object sender, EventArgs e)
		{
			ObservableCollection<Personal> coleccion = new ObservableCollection<Personal>();
			Personal per = new Personal();
