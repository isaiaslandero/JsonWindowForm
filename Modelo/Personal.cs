...
namespace JsonWindowForm.Modelo
{
	public class Personal
	{
		...
		public void ConvertiraJSON(ObservableCollection<Personal> personal_c) 
		{
			string path_direcctorio = @"C:\Isaias";
			string path_archivo = @"C:\Isaias\isaiasJONSON.json";
			string convertir = JsonConvert.SerializeObject(personal_c.ToArray(), Formatting.Indented);
